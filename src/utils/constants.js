...
export const SLOTS = [
  ...
  { id: 5, label: 'Slot 5', startTime: '13:30', endTime: '14:00', time: '1:30 PM - 2:00 PM' },
  { id: 6, label: 'Slot 6', startTime: '14:00', endTime: '14:30', time: '2:00 PM - 2:30 PM' },
  { id: 7, label: 'Slot 7', startTime: '14:30', endTime: '15:00', time: '2:30 PM - 3:00 PM' },
  { id: 8, label: 'Slot 8', startTime: '15:00', endTime: '15:30', time: '3:00 PM - 3:30 PM' },
  { id: 9, label: 'Slot 9', startTime: '15:30', endTime: '16:00', time: '3:30 PM - 4:00 PM' },
  { id: 10, label: 'Slot 10', startTime: '16:00', endTime: '16:30', time: '4:00 PM - 4:30 PM' },
  { id: 11, label: 'Slot 11', startTime: '16:30', endTime: '17:00', time: '4:30 PM - 5:00 PM' },
   { id: 12, label: 'Slot 12', startTime: '17:00', endTime: '17:30', time: '5:00 PM - 5:30 PM' },
];
...
export const GAMES = [
  { id: 'carrom', name: 'Carrom', icon: 'CARROM', location: '----', maxPlayers: 4 },
  { id: 'chess', name: 'Chess', icon: 'CHESS', location: '----', maxPlayers: 2 },
];
